...
const Referral = (props) => {
  ...
  return (
    ...
    <Container component="main" maxWidth="xs">
      ...
      <AlertDialog open={referraldata.error.flag && clicked} onClose={handleClose}>{language.update_failed}</AlertDialog>
    </Container>
  );
