const stripe = require('stripe')('XXXXXXXXXXXXXXXXX');
const stripe_public_key = 'XXXXXXXXXXXXXXXXX';
...
module.exports.render_checkout = function(request, response){
    ...
    var product_name = request.body.product_name?request.body.product_name:"Baden Booking";
