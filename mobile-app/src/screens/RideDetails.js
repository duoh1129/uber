    ...
    return (
        <View style={styles.mainView}>
            ...
            <ScrollView>
                ...
                <View style={styles.rideDesc}>
                    ...
                    <View style={styles.userDesc}>
                        ...
                        <View style={styles.userView}>
                            ...
                            {paramData && paramData.driverRating > 0 ?
                                ...
                                <View style={styles.personTextView}>
                                    ...
                                    <Rating
                                        ...
                                        type="star"
                                        fractions={3}
                                        startingValue={parseFloat(paramData.driverRating)}
                                        readonly
                                        imageSize={15}
                ...
                {paramData && ['STARTED','ENDED','PAID','COMPLETE'].indexOf(paramData.status) != -1 ?
                        ...
                        {paramData && paramData.status ?
                            <View style={styles.billOptions}>
                                <View style={styles.billItem}>
                                    ...
                                    <Text style={styles.billAmount}>{paramData.status == "PENDING" ? "Yet to pay" : paramData.status}</Text>
                ...
                :null}
                {paramData ? ['ACCEPTED','ARRIVED','STARTED','ENDED','PAID'].indexOf(paramData.status) != -1?
