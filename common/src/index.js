...
const FirebaseProvider  = ({ children }) => {
    ...
    if (!app.apps.length) {
        ...
        firebase = {
            ...
            aboutusRef:app.database().ref("About_Us"),        
            ...
            tasksRef:(uid) => app.database().ref('bookings').orderByChild('requestedDrivers/' + uid).equalTo(true),
            ...
            api: {
                ...
                fetchAboutUs: () => (dispatch) => fetchAboutUs()(dispatch)(firebase),
