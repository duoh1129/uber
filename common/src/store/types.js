...
export const VALIDATE_REFERER = "VALIDATE_REFERER";
export const VALIDATE_REFERER_SUCCESS = "VALIDATE_REFERER_SUCCESS";
export const VALIDATE_REFERER_FAILED = "VALIDATE_REFERER_FAILED";
